 ...
 * Run: node build_inline_viewer.cjs
 */
...
// Output goes to the pack-level web/js/ - that is the WEB_DIRECTORY ComfyUI
// actually serves/loads; a component-local copy would never be loaded.
